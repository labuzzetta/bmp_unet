...
ids_train_split = [s.split("_")[8] for s in glob.glob("/work/LAS/zhuz-lab/clabuzze/pond_dam_pps_sq/hillshade_clipped_IA_halfFishs/pond_dam/*.tif")]
    ...
    while True:
        ...
        for start in range(0, len(ids_train_split), batch_size):
            ...
            for id in ids_train_batch:
                ...
                img = cv2.imread('/work/LAS/zhuz-lab/clabuzze/pond_dam_pps_sq/hillshade_clipped_IA_halfFishs/pond_dam/fishGrid_{}_lidar_hs_1m.tif'.format(id))
                ...
                img2 = cv2.imread('/work/LAS/zhuz-lab/clabuzze/pond_dam_pps_sq/ortho_clipped_IA_halfFishs_2007_2010/pond_dam/fishGrid_{}_ortho_2007_2010_cir.tif'.format(id))
                try:
                    img2 = cv2.resize(img2, (input_size, input_size)) 
                except Exception as e:
                    print(str(e))

                mask = cv2.imread('/work/LAS/zhuz-lab/clabuzze/pond_dam_pps_sq/pd_raster_clipped_IA_halfFishs/fishGrid_{}.tif'.format(id))
...
model.save('/work/LAS/zhuz-lab/clabuzze/model_wrr_pd_cldice.h5')
